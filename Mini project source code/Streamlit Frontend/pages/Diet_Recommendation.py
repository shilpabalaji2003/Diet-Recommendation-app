        ...
        for dish_name in dishes:
            for dish in dish_dict:
                if dish['name'] in dish_name:
                    ...
                    with image_col:
                        st.image(dish['image'], caption=dish['name'], width=300)
                    with desc_col:
