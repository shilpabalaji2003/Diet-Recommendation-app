...
class Display:
    ...
    def display_recommendations(self, breakfast, lunch, dinner):
        ...
        with st.spinner('Generating recommendations...'):
            ...
            # Function to display each dish as a card
            def display_dish_card(meal, dishes):
                st.subheader(f"{meal} Recommendation")
                st.markdown(
                    """
                    <style>
                        .card-container {
            ...
            # Display cards for breakfast recommendations
            display_dish_card("Breakfast", breakfast)
            
            # Display cards for lunch recommendations
            display_dish_card("Lunch", lunch)
            
            # Display cards for dinner recommendations
            display_dish_card("Dinner", dinner)
